namespace BizTalkDeploymentTool.Wmi
{
    ...
    public class ReceiveLocation : System.ComponentModel.Component {
        ...
        public static ReceiveLocationCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static ReceiveLocationCollection GetInstances(string condition, string[] selectedProperties) {
        ...
        public static ReceiveLocationCollection GetInstances(System.Management.ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static ReceiveLocationCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\MicrosoftBizTalkServer";
